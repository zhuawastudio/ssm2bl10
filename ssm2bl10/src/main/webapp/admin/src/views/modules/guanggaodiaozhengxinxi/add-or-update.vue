<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="上线时间" prop="shangxianshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.shangxianshijian" 
                type="datetime"
                placeholder="上线时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shangxianshijian" label="上线时间" prop="shangxianshijian">
              <el-input v-model="ruleForm.shangxianshijian" 
                placeholder="上线时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="上线策略要求" prop="shangxiancelveyaoqiu">
          <el-input v-model="ruleForm.shangxiancelveyaoqiu" 
              placeholder="上线策略要求" clearable  :readonly="ro.shangxiancelveyaoqiu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="上线策略要求" prop="shangxiancelveyaoqiu">
              <el-input v-model="ruleForm.shangxiancelveyaoqiu" 
                placeholder="上线策略要求" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="调整内容" prop="diaozhengneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.diaozhengneirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.diaozhengneirong" label="调整内容" prop="diaozhengneirong">
                    <span v-html="ruleForm.diaozhengneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	shangxianshijian : false,
	shangxiancelveyaoqiu : false,
	diaozhengneirong : false,
	kehuzhanghao : false,
	kehuxingming : false,
      },
      ruleForm: {
  ...
  created() {
	this.ruleForm.shangxianshijian = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.guanggaoyaoqiu = true;
          ...
          if(o=='shangxianshijian'){
            this.ruleForm.shangxianshijian = obj[o];
	    this.ro.shangxianshijian = true;
            continue;
          }
          if(o=='shangxiancelveyaoqiu'){
            this.ruleForm.shangxiancelveyaoqiu = obj[o];
	    this.ro.shangxiancelveyaoqiu = true;
            continue;
          }
          if(o=='diaozhengneirong'){
            this.ruleForm.diaozhengneirong = obj[o];
	    this.ro.diaozhengneirong = true;
            continue;
          }
          if(o=='kehuzhanghao'){
    ...
    info(id) {
      this.$http({
        url: `guanggaodiaozhengxinxi/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
	...
	this.ruleForm.diaozhengneirong = this.ruleForm.diaozhengneirong.replace(reg,'../../../ssm2bl10/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `guanggaodiaozhengxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.guanggaodiaozhengxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
