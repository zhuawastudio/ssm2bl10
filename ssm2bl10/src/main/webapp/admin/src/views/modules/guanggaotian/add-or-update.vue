<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="提案时间" prop="tianshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.tianshijian" 
                type="datetime"
                placeholder="提案时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tianshijian" label="提案时间" prop="tianshijian">
              <el-input v-model="ruleForm.tianshijian" 
                placeholder="提案时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="提案内容" prop="tianneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.tianneirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.tianneirong" label="提案内容" prop="tianneirong">
                    <span v-html="ruleForm.tianneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.tianshijian = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.guanggaoyaoqiu = true;
          ...
          if(o=='tianneirong'){
            this.ruleForm.tianneirong = obj[o];
	    this.ro.tianneirong = true;
            continue;
          }
          if(o=='tianshijian'){
            this.ruleForm.tianshijian = obj[o];
	    this.ro.tianshijian = true;
            continue;
          }
          if(o=='kehuzhanghao'){
	...
	this.ruleForm.tianneirong = this.ruleForm.tianneirong.replace(reg,'../../../ssm2bl10/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `guanggaotian/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.guanggaotianCrossAddOrUpdateFlag = false;
                  this.parent.search();
