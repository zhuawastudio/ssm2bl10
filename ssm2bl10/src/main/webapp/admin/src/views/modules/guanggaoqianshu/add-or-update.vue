<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="广告总费用" prop="guanggaozongfeiyong">
          <el-input v-model="ruleForm.guanggaozongfeiyong" 
              placeholder="广告总费用" clearable  :readonly="ro.guanggaozongfeiyong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="广告总费用" prop="guanggaozongfeiyong">
              <el-input v-model="ruleForm.guanggaozongfeiyong" 
                placeholder="广告总费用" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="签署时间" prop="qianshushijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.qianshushijian" 
                type="datetime"
                placeholder="签署时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.qianshushijian" label="签署时间" prop="qianshushijian">
              <el-input v-model="ruleForm.qianshushijian" 
                placeholder="签署时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="协议内容" prop="xieyineirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.xieyineirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xieyineirong" label="协议内容" prop="xieyineirong">
                    <span v-html="ruleForm.xieyineirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	guanggaozongfeiyong : false,
	qianshushijian : false,
	xieyineirong : false,
	kehuzhanghao : false,
	kehuxingming : false,
	sfsh : false,
  ...
  created() {
	this.ruleForm.qianshushijian = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.guanggaoshangmingcheng = true;
          ...
          if(o=='guanggaozongfeiyong'){
            this.ruleForm.guanggaozongfeiyong = obj[o];
	    this.ro.guanggaozongfeiyong = true;
            continue;
          }
          if(o=='qianshushijian'){
            this.ruleForm.qianshushijian = obj[o];
	    this.ro.qianshushijian = true;
            continue;
          }
          if(o=='xieyineirong'){
            this.ruleForm.xieyineirong = obj[o];
	    this.ro.xieyineirong = true;
            continue;
          }
          if(o=='kehuzhanghao'){
	...
	this.ruleForm.xieyineirong = this.ruleForm.xieyineirong.replace(reg,'../../../ssm2bl10/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `guanggaoqianshu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.guanggaoqianshuCrossAddOrUpdateFlag = false;
                  this.parent.search();
